...
|---------|-------|--------|
| **Inizio sessione** ("lavora su X", "fix in X") | `gitnexus-context` | Carica grafo codebase + 15 learnings rilevanti |
...
| Situazione | Skill |
|-----------|-------|
| Inizio qualsiasi sessione su un progetto | `.agents/skills/gitnexus-context` |
