---
name: figma
description: Figma MCP integration - leggi file Figma, estrai design tokens, genera codice Tailwind/shadcn pixel-perfect. Use when given a Figma URL to implement, extracting design tokens, or converting Figma designs to code.
version: 1.0.0
---
