...
description: >
  ...
  Triggers on: "done", "fixed", "ready to commit", "tests pass", "build succeeds", any success claim.
  Requires running verification commands and confirming output before making any success claims.
  Evidence before assertions always.
version: 1.0.0
user-invocable: true
argument-hint: "cosa verificare prima di dichiarare done"
---
...
Solution: Partial proves nothing. Run the FULL verification command. Check exit code and all output.
