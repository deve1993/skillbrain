...
export function extractSymbols(sourceFile, relativePath) {
    const nodes = [];
    // File node
    nodes.push({
...
function functionNode(fn, name, filePath) {
    return {
...
function classNode(cls, name, filePath) {
    return {
...
function interfaceNode(iface, name, filePath) {
    return {
