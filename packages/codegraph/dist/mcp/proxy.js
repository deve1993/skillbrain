 ...
 */
export function findReusableSession(sessions, now, windowMs) {
...
export async function startProxy() {
    ...
    const clientTransport = new StreamableHTTPClientTransport(new URL(REMOTE_URL), {
    ...
    try {
        ...
        let sessions = [];
        try {
            sessions = JSON.parse(historyText);
        }
        catch { }
