...
description: >
  ...
  Triggers on: "execute the plan here", "dispatch subagents", "implement with reviews", any same-session execution request.
...
Solution: Dispatch fix subagent with specific instructions. Don't try to fix manually (context pollution).
