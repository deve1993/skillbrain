...
### Step 2 — CodeGraph: stato indici

Esegui da terminale:
```bash
node "/Users/dan/Desktop/progetti-web/Fullstack session/packages/codegraph/dist/cli.js" list
```
...
```bash
node "/Users/dan/Desktop/progetti-web/Fullstack session/packages/codegraph/dist/cli.js" analyze "[path-repo]"
```
...
- Il re-indice CodeGraph avviene sempre in background (non blocca)
