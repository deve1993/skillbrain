...
description: >
  Use when encountering any bug, test failure, unexpected behavior, or error.
  Triggers on: "it's broken", "this doesn't work", "I'm getting an error", "fix this bug", any unexpected behavior.
  Requires finding root cause before attempting fixes. Symptom fixes are failure.
version: 1.0.0
user-invocable: true
argument-hint: "descrivi il bug o comportamento inatteso"
...
Solution: Gather more data. Ask user for exact steps. Add logging. Don't guess without reproduction.
