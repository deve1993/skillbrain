...
description: >
  ...
  Triggers on: "multiple failures", "parallel work", "independent problems", any multi-domain issue.
  Dispatches one agent per independent problem domain for concurrent investigation.
version: 1.0.0
---
...
Solution: That's fine. Review their summary while others work. Integrate when all complete.
